...
void count_different_mapping(std::vector<SAM_entry>& SAM_data, 
							 int& Uniq_right,
							 int& Uniq_right_0_score,
							 int& nonUniq_right,
							 int& Uniq_wrong,
							 int& Uniq_wrong_0_score,
							 int& nonUniq_wrong)
{
    float SAM_size = SAM_data.size();
	Uniq_right = 0;
	Uniq_right_0_score = 0;
	nonUniq_right = 0;
	Uniq_wrong = 0;
	Uniq_wrong_0_score = 0;
	nonUniq_wrong = 0;
...
int main(int argc, char* argv[])
{
    ...
    std::string output_tsv_filename = SAM_filename+ std::string(".different_mapping_count_SumUp.tsv");
	std::ofstream output_tsv(output_tsv_filename);

	int Uniq_right = 0;
	int Uniq_right_0_score = 0;
	int nonUniq_right = 0;
	int Uniq_wrong = 0;
	int Uniq_wrong_0_score = 0;
	int nonUniq_wrong = 0;
